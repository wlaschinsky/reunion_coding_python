...
print(len(heslo) > 5 and any(znak.isdigit() for znak in heslo))

# rozepsane
# 1. Kontrola na číslici
ma_cislici = False
for znak in heslo:
    if znak.isdigit():
        ma_cislici = True
...
# 3. Vyhodnocení obou podmínek
if len(heslo) > 5 and ma_cislici: # bud pouziju tu zakomentovanou cast rozepsanou, a nebo tuhle zkracenou 
    print("OK")
else:
    print("SLABÉ")
